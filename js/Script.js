...
// function homeDisplayUpcomingMovies(upcomingMoviesArray) {
//     const homeUpcomingContainer = document.getElementById('homeUpcomingMoviesGrid');

//     const watchList = JSON.parse(localStorage.getItem("watchList")) || [];

//     homeUpcomingContainer.innerHTML = upcomingMoviesArray.map(movie => {
//         const isInWatchlist = watchList.some(m => m.id == movie.id);

//         return `
//         <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
//             <div class="homeUpcomingMovieCard card" style="width: 18rem;" data-movie-id="${movie.id}">
//                 <img src="${movie.image}" class="card-img-top" alt="...">
//                 <div class="card-body">
//                     <h5 class="home-upcoming-card-title">${movie.title}</h5>
//                     <p class="home-upcoming-card-text">${movie.releaseDate}</p>
//                     <div class="d-flex justify-content-center gap-2 mt-2">
//                         <button class="movie-card-details-btn btn" onclick="goToDetails(${movie.id})">Details</button>
//                         <button class="movie-card-watchlist-btn btn" 
//                             onclick="addToWatchlistFromElement(this)" 
//                             style="${isInWatchlist ? 'display:none;' : ''}">Add to Watchlist</button>
//                         <button class="movie-card-remove-btn btn" 
//                             onclick="removeFromWatchlistFromElement(this)" 
//                             style="${isInWatchlist ? '' : 'display:none;'}">Remove</button>
//                     </div>
//                 </div>
//             </div>
//         </div>
...
function homeDisplayPopularMovies(homeMoviesArray) {
    ...
    homePopularContainer.innerHTML = homeMoviesArray.map(movie => {
        ...
        return `
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="homePopularMovieCard card" style="width: 18rem;" data-movie-id="${movie.id}">
                <img src="${movie.image}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="home-popular-card-title">${movie.title}</h5>
                    <p class="home-popular-card-text">${movie.popularity}</p>
...
//         `).join('');
// }
function homeDisplayTopRatedMovies(topRatedMoviesArray) {
    const homeTopRatedContainer = document.getElementById('homeTopRatedMoviesGrid');

    const watchList = JSON.parse(localStorage.getItem("watchList")) || [];

    homeTopRatedContainer.innerHTML = topRatedMoviesArray.map(movie => {
        const isInWatchlist = watchList.some(m => m.id == movie.id);

        return `
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="homeTopRatedMovieCard card" style="width: 18rem;" data-movie-id="${movie.id}">
                <img src="${movie.image}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="home-toprated-card-title">${movie.title}</h5>
                    <p class="home-toprated-card-text">${movie.rating}</p>
                    <div class="d-flex justify-content-center gap-2 mt-2">
                        <button class="movie-card-details-btn btn" onclick="goToDetails(${movie.id})">Details</button>
                        <button class="movie-card-watchlist-btn btn" 
                            onclick="addToWatchlistFromElement(this)" 
